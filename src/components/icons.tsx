...
export function PaypalIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export function SpotifyIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export function Sliders({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function Share({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function Plus({ className = 'w-4 h-4', strokeWidth = 2, ...props }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth={strokeWidth} viewBox="0 0 24 24" {...props}>
...
export function Dots({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export function ChartIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24" {...props}>
...
export function ChartPlusIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24" {...props}>
      <rect height="14" rx="3" strokeLinecap="round" strokeLinejoin="round" width="18" x="3" y="5" />
...
export function ChartAxisIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function NavHome({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function NavWallet({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function NavChart({ className = 'w-5 h-5', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function TargetIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function CreditCardIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function RepeatIcon({ className = 'w-4 h-4', ...props }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
